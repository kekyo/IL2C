...
extern intptr_t System_Runtime_InteropServices_GCHandle_ToIntPtr(System_Runtime_InteropServices_GCHandle* this__);
...
extern /* static */ System_Runtime_InteropServices_GCHandle System_Runtime_InteropServices_GCHandle_FromIntPtr(intptr_t value);
