...
//   so, it vtable's adjustor offset set to the minus offset.
//
// The boxed value type instance:
//   +----------------------+
//   | IL2C_REF_HEADER      |
//   +----------------------+ <-- pBoxed     ---------------------------   <-----+ Adjustor offset has to decrease
//   | vptr0__              | <-- pVTable      | sizeof(System_ValueType)        | (It's System_ValueType_VTABLE__ or IL2C generated if type had overrided member)
//   +----------------------+                -----------                   ------+-------+----+
//   |        :             |                  ^                                         |    |
//   | (value data)         |                  | The value real data                     |    | Adjustor offset has to increase from real value data
