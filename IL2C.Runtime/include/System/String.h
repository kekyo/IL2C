...
typedef bool (*IL2C_FORMAT_TOKEN_WRITER)(const wchar_t* pFrom, uint32_t length, void* pState);
typedef bool (*IL2C_FORMAT_ARGUMENT_WRITER)(uint32_t argumentIndex, void* pState);
extern bool il2c_format_string__(
