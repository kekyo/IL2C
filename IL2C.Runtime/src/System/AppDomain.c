...
void System_AppDomain_add_UnhandledException(System_AppDomain* this__, System_UnhandledExceptionEventHandler* value)
{
    ...
    this__->unhandledExceptionEventHandler__ =
        (System_UnhandledExceptionEventHandler*)System_Delegate_Combine(
            (System_Delegate*)this__->unhandledExceptionEventHandler__,
            (System_Delegate*)value);
}

void System_AppDomain_remove_UnhandledException(System_AppDomain* this__, System_UnhandledExceptionEventHandler* value)
{
    il2c_assert(this__ != NULL);
    ...
    this__->unhandledExceptionEventHandler__ =
        (System_UnhandledExceptionEventHandler*)System_Delegate_Remove(
            (System_Delegate*)this__->unhandledExceptionEventHandler__,
            (System_Delegate*)value);
}
...
void il2c_invoke_unhandled_exception_on_the_current_domain__(System_Object* exception)
{
    ...
    if (pHandler != NULL)
    {
        ...
        System_UnhandledExceptionEventArgs__ctor(pArgs, exception, false);
