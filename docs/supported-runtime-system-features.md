...
| TypeInitializer | [Test [21]](../tests/IL2C.Core.Test.RuntimeSystems/TypeInitializer) | These tests are verified the IL2C can handle the type initializer special translation cases. |
