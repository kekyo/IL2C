...
extern /* protected override sealed */ void MT3620Blink_Timer_OnRaised(MT3620Blink_Timer* this__);
...
int32_t MT3620Blink_Timer_MT3620Blink_IEPollListener_get_Identity(MT3620Blink_Timer* this__)
{
    ...
    /* IL_0000: ldarg.0                         : Timer.cs(42) */
    frame__.stack0_0__ = this__;
    /* IL_0001: call MT3620Blink.Descriptor.get_Identity : Timer.cs(42) */
    stack0_1__ = MT3620Blink_Descriptor_get_Identity((MT3620Blink_Descriptor*)frame__.stack0_0__);
    /* IL_0006: ret                             : Timer.cs(42) */
    il2c_unlink_execution_frame(&frame__);
    return stack0_1__;
}
...
void MT3620Blink_Timer_MT3620Blink_IEPollListener_OnRaised(MT3620Blink_Timer* this__)
{
    ...
    /* IL_0000: ldarg.0                         : Timer.cs(43) */
    frame__.stack0_0__ = this__;
    /* IL_0001: callvirt MT3620Blink.Descriptor.OnRaised : Timer.cs(43) */
    frame__.stack0_0__->vptr0__->OnRaised((MT3620Blink_Descriptor*)il2c_adjusted_reference(frame__.stack0_0__));
    /* IL_0006: nop                             : Timer.cs(43) */
    /* IL_0007: ret  */
    il2c_unlink_execution_frame(&frame__);
    return;
}
