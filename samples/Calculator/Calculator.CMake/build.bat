...
cmake -G "Unix Makefiles" -DCMAKE_MAKE_PROGRAM=mingw32-make.exe -DBUILDER=gcc4-win-mingw32 -DPLATFORM=mingw32 -DCONFIGURATION=%Configuration% ../..

rem For use Ninja
rem cmake -G "Ninja" -DCMAKE_MAKE_PROGRAM=ninja.exe -DBUILDER=gcc4-win-mingw32 -DPLATFORM=mingw32 -DCONFIGURATION=%Configuration% ../..
