...
void Calculator_PolishNotation_Main(void)
{
    ...
    /* IL_0000: nop                             : PolishNotation.cs(200) */
    /* IL_0001: ldstr "Polish notation calculator." */
    frame__.stack0_0__ = Calculator_Core_string0__;
    /* IL_0006: call System.Console.WriteLine   : PolishNotation.cs(201) */
    System_Console_WriteLine_10(frame__.stack0_0__);
    /* IL_000b: nop                             : PolishNotation.cs(201) */
    /* IL_000c: ldstr "This is proof of concept for IL2C." */
    frame__.stack0_0__ = Calculator_Core_string1__;
    /* IL_0011: call System.Console.WriteLine   : PolishNotation.cs(202) */
    System_Console_WriteLine_10(frame__.stack0_0__);
    /* IL_0016: nop                             : PolishNotation.cs(202) */
    /* IL_0017: ldstr "https://github.com/kekyo/IL2C" */
    frame__.stack0_0__ = Calculator_Core_string2__;
    /* IL_001c: call System.Console.WriteLine   : PolishNotation.cs(203) */
    System_Console_WriteLine_10(frame__.stack0_0__);
    /* IL_0021: nop                             : PolishNotation.cs(203) */
    /* IL_0022: call System.Console.WriteLine */
    System_Console_WriteLine();
    /* IL_0027: nop                             : PolishNotation.cs(204) */
    /* IL_0028: ldstr "Type "exit" to exit." */
    frame__.stack0_0__ = Calculator_Core_string3__;
    /* IL_002d: call System.Console.WriteLine   : PolishNotation.cs(205) */
    System_Console_WriteLine_10(frame__.stack0_0__);
    /* IL_0032: nop                             : PolishNotation.cs(205) */
    /* IL_0033: ldstr "Example: "+ 2 3"" */
    frame__.stack0_0__ = Calculator_Core_string4__;
    /* IL_0038: call System.Console.WriteLine   : PolishNotation.cs(206) */
    System_Console_WriteLine_10(frame__.stack0_0__);
    /* IL_003d: nop                             : PolishNotation.cs(206) */
    /* IL_003e: ldstr "Example: "* + 2 3 6"" */
    frame__.stack0_0__ = Calculator_Core_string5__;
    /* IL_0043: call System.Console.WriteLine   : PolishNotation.cs(207) */
    System_Console_WriteLine_10(frame__.stack0_0__);
    /* IL_0048: nop                             : PolishNotation.cs(207) */
    /* IL_0049: br.s IL_00c0 */
    goto IL_00c0;
IL_004b:
    /* IL_004b: nop                             : PolishNotation.cs(210) */
    /* IL_004c: call System.Console.WriteLine */
    System_Console_WriteLine();
    /* IL_0051: nop                             : PolishNotation.cs(211) */
    /* IL_0052: ldstr "PN> " */
    frame__.stack0_0__ = Calculator_Core_string6__;
    /* IL_0057: call System.Console.Write       : PolishNotation.cs(212) */
    System_Console_Write_9(frame__.stack0_0__);
    /* IL_005c: nop                             : PolishNotation.cs(212) */
    /* IL_005d: call System.Console.ReadLine */
    frame__.stack0_0__ = System_Console_ReadLine();
    /* IL_0062: stloc.0                         : PolishNotation.cs(213) */
    frame__.line = frame__.stack0_0__;
    /* IL_0063: ldloc.0                         : PolishNotation.cs(214) */
    frame__.stack0_0__ = frame__.line;
    /* IL_0064: call System.String.IsNullOrWhiteSpace : PolishNotation.cs(214) */
    stack0_2__ = System_String_IsNullOrWhiteSpace(frame__.stack0_0__);
    /* IL_0069: ldc.i4.0                        : PolishNotation.cs(214) */
    stack1_0__ = 0;
    /* IL_006a: ceq                             : PolishNotation.cs(214) */
    stack0_1__ = (int32_t)stack0_2__ == (int32_t)stack1_0__;
    /* IL_006c: stloc.1                         : PolishNotation.cs(214) */
    local1__ = (bool)stack0_1__;
    /* IL_006d: ldloc.1                         : PolishNotation.cs(214) */
    stack0_2__ = local1__;
    /* IL_006e: brfalse.s IL_00bf               : PolishNotation.cs(214) */
    if (stack0_2__ == false) goto IL_00bf;
    /* IL_0070: nop                             : PolishNotation.cs(215) */
    /* IL_0071: ldloc.0  */
    frame__.stack0_0__ = frame__.line;
    /* IL_0072: ldstr "exit"                    : PolishNotation.cs(216) */
    frame__.stack1_1__ = Calculator_Core_string7__;
    /* IL_0077: call System.String.op_Equality  : PolishNotation.cs(216) */
    stack0_2__ = System_String_op_Equality(frame__.stack0_0__, frame__.stack1_1__);
    /* IL_007c: stloc.s local4__                : PolishNotation.cs(216) */
    local4__ = stack0_2__;
    /* IL_007e: ldloc.s local4__                : PolishNotation.cs(216) */
    stack0_2__ = local4__;
    /* IL_0080: brfalse.s IL_0085               : PolishNotation.cs(216) */
    if (stack0_2__ == false) goto IL_0085;
    /* IL_0082: nop                             : PolishNotation.cs(217) */
    /* IL_0083: br.s IL_00c5 */
    goto IL_00c5;
IL_0085:
    /* IL_0085: ldloc.0                         : PolishNotation.cs(221) */
    frame__.stack0_0__ = frame__.line;
    /* IL_0086: ldc.i4.0                        : PolishNotation.cs(221) */
    stack1_0__ = 0;
    /* IL_0087: call Calculator.PolishNotation.ParseExpression : PolishNotation.cs(221) */
    frame__.stack0_3__ = Calculator_PolishNotation_ParseExpression(frame__.stack0_0__, stack1_0__);
    /* IL_008c: stloc.2                         : PolishNotation.cs(221) */
    frame__.expr = frame__.stack0_3__;
    /* IL_008d: ldloc.2                         : PolishNotation.cs(222) */
    frame__.stack0_3__ = frame__.expr;
    /* IL_008e: ldnull                          : PolishNotation.cs(222) */
    stack1_2__ = NULL;
    /* IL_008f: ceq                             : PolishNotation.cs(222) */
    stack0_1__ = (intptr_t)frame__.stack0_3__ == (intptr_t)stack1_2__;
    /* IL_0091: stloc.s local5__                : PolishNotation.cs(222) */
    local5__ = (bool)stack0_1__;
    /* IL_0093: ldloc.s local5__                : PolishNotation.cs(222) */
    stack0_2__ = local5__;
    /* IL_0095: brfalse.s IL_00a5               : PolishNotation.cs(222) */
    if (stack0_2__ == false) goto IL_00a5;
    /* IL_0097: nop                             : PolishNotation.cs(223) */
    /* IL_0098: ldstr "Syntax error." */
    frame__.stack0_0__ = Calculator_Core_string8__;
    /* IL_009d: call System.Console.WriteLine   : PolishNotation.cs(224) */
    System_Console_WriteLine_10(frame__.stack0_0__);
    /* IL_00a2: nop                             : PolishNotation.cs(224) */
    /* IL_00a3: br.s IL_00c0 */
    goto IL_00c0;
IL_00a5:
    /* IL_00a5: ldloc.2                         : PolishNotation.cs(228) */
    frame__.stack0_3__ = frame__.expr;
    /* IL_00a6: callvirt Calculator.ReducibleNode.Reduce : PolishNotation.cs(228) */
    stack0_1__ = frame__.stack0_3__->vptr0__->Reduce((Calculator_ReducibleNode*)frame__.stack0_3__);
    /* IL_00ab: stloc.3                         : PolishNotation.cs(228) */
    result = stack0_1__;
    /* IL_00ac: ldstr "Reuslt="                 : PolishNotation.cs(230) */
    frame__.stack0_0__ = Calculator_Core_string9__;
    /* IL_00b1: call System.Console.Write       : PolishNotation.cs(230) */
    System_Console_Write_9(frame__.stack0_0__);
    /* IL_00b6: nop                             : PolishNotation.cs(230) */
    /* IL_00b7: ldloc.3  */
    stack0_1__ = result;
    /* IL_00b8: call System.Console.WriteLine   : PolishNotation.cs(231) */
    System_Console_WriteLine_6(stack0_1__);
    /* IL_00bd: nop                             : PolishNotation.cs(231) */
    /* IL_00be: nop  */
IL_00bf:
    /* IL_00bf: nop  */
IL_00c0:
    /* IL_00c0: ldc.i4.1  */
    stack0_1__ = 1;
    /* IL_00c1: stloc.s local6__                : PolishNotation.cs(209) */
    local6__ = (bool)stack0_1__;
    /* IL_00c3: br.s IL_004b                    : PolishNotation.cs(209) */
    goto IL_004b;
IL_00c5:
