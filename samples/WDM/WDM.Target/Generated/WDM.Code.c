...
__WDM_Code_InterceptCDRomDevice_VTABLE_DECL__ __WDM_Code_InterceptCDRomDevice_VTABLE__ = {
    (void* (*)(WDM_Code_InterceptCDRomDevice*, IL2C_RUNTIME_TYPE_DECL*))__WDM_Code_InterceptCDRomDevice_IL2C_RuntimeCast__,
    (System_String* (*)(WDM_Code_InterceptCDRomDevice*))__System_Object_ToString__,
    (int32_t (*)(WDM_Code_InterceptCDRomDevice*))__System_Object_GetHashCode__,
    (void (*)(WDM_Code_InterceptCDRomDevice*))__System_Object_Finalize__,
    (bool (*)(WDM_Code_InterceptCDRomDevice*, System_Object*))__System_Object_Equals__,
};
...
__WDM_Code_Wdm_VTABLE_DECL__ __WDM_Code_Wdm_VTABLE__ = {
    (void* (*)(WDM_Code_Wdm*, IL2C_RUNTIME_TYPE_DECL*))__WDM_Code_Wdm_IL2C_RuntimeCast__,
    (System_String* (*)(WDM_Code_Wdm*))__System_Object_ToString__,
    (int32_t (*)(WDM_Code_Wdm*))__System_Object_GetHashCode__,
    (void (*)(WDM_Code_Wdm*))__System_Object_Finalize__,
    (bool (*)(WDM_Code_Wdm*, System_Object*))__System_Object_Equals__,
};
