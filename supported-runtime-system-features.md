...
| Interoperability | [Test [1]](tests/IL2C.Core.Test.Target/RuntimeSystems/Interoperability) | These tests are verified the IL2C manages interoperability with the P/Invoke method and internalcall method. |
