...
namespace IL2C.ILConverters
{
    ...
    [Case(uint.MaxValue - 1, "UInt32", uint.MaxValue)]
    [Case(ulong.MaxValue - 1, "UInt64", ulong.MaxValue)]
    [Case(int.MaxValue - 1, "IntPtr", int.MaxValue)]
    [Case(uint.MaxValue - 1, "UIntPtr", uint.MaxValue)]
