...
namespace IL2C.ILConverters
{
    ...
    [Case(uint.MaxValue - 1, "UInt32", 123, uint.MaxValue)]
    [Case(ulong.MaxValue - 1, "UInt64", 123, ulong.MaxValue)]
    [Case(int.MaxValue - 1, "IntPtr", 123, int.MaxValue)]
    [Case(uint.MaxValue - 1, "UIntPtr", 123, uint.MaxValue)]
