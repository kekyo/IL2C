...
namespace IL2C.ILConverters
{
    ...
    [Case(uint.MaxValue - 1, "UInt32", 123, 45, uint.MaxValue)]
    [Case(ulong.MaxValue - 1, "UInt64", 123, 45, ulong.MaxValue)]
    [Case(int.MaxValue - 1, "IntPtr", 123, 45, int.MaxValue)]
    [Case(uint.MaxValue - 1, "UIntPtr", 123, 45, uint.MaxValue)]
