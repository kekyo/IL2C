...
#define UEFI_Code_AbstractNode_GetHashCode(/* UEFI_Code_AbstractNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_AbstractNode, this__)->GetHashCode((System_Object*)this__))
#define UEFI_Code_AbstractNode_Finalize(/* UEFI_Code_AbstractNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_AbstractNode, this__)->Finalize((System_Object*)this__))
#define UEFI_Code_AbstractNode_Equals(/* UEFI_Code_AbstractNode* */ this__, /* System_Object* */ obj) \
    (il2c_get_vtable(UEFI_Code_AbstractNode, this__)->Equals((System_Object*)this__, obj))
...
#define UEFI_Code_OperatorNode_GetHashCode(/* UEFI_Code_OperatorNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_OperatorNode, this__)->GetHashCode((System_Object*)this__))
#define UEFI_Code_OperatorNode_Finalize(/* UEFI_Code_OperatorNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_OperatorNode, this__)->Finalize((System_Object*)this__))
#define UEFI_Code_OperatorNode_Equals(/* UEFI_Code_OperatorNode* */ this__, /* System_Object* */ obj) \
    (il2c_get_vtable(UEFI_Code_OperatorNode, this__)->Equals((System_Object*)this__, obj))
...
#define UEFI_Code_ReducibleNode_GetHashCode(/* UEFI_Code_ReducibleNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_ReducibleNode, this__)->GetHashCode((System_Object*)this__))
#define UEFI_Code_ReducibleNode_Finalize(/* UEFI_Code_ReducibleNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_ReducibleNode, this__)->Finalize((System_Object*)this__))
#define UEFI_Code_ReducibleNode_Equals(/* UEFI_Code_ReducibleNode* */ this__, /* System_Object* */ obj) \
    (il2c_get_vtable(UEFI_Code_ReducibleNode, this__)->Equals((System_Object*)this__, obj))
#define UEFI_Code_ReducibleNode_Reduce(/* UEFI_Code_ReducibleNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_ReducibleNode, this__)->Reduce((UEFI_Code_ReducibleNode*)this__))
...
#define UEFI_Code_NumericNode_GetHashCode(/* UEFI_Code_NumericNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_NumericNode, this__)->GetHashCode((System_Object*)this__))
#define UEFI_Code_NumericNode_Finalize(/* UEFI_Code_NumericNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_NumericNode, this__)->Finalize((System_Object*)this__))
#define UEFI_Code_NumericNode_Equals(/* UEFI_Code_NumericNode* */ this__, /* System_Object* */ obj) \
    (il2c_get_vtable(UEFI_Code_NumericNode, this__)->Equals((System_Object*)this__, obj))
#define UEFI_Code_NumericNode_Reduce(/* UEFI_Code_NumericNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_NumericNode, this__)->Reduce((UEFI_Code_NumericNode*)this__))
...
#define UEFI_Code_ExpressionNode_GetHashCode(/* UEFI_Code_ExpressionNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_ExpressionNode, this__)->GetHashCode((System_Object*)this__))
#define UEFI_Code_ExpressionNode_Finalize(/* UEFI_Code_ExpressionNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_ExpressionNode, this__)->Finalize((System_Object*)this__))
#define UEFI_Code_ExpressionNode_Equals(/* UEFI_Code_ExpressionNode* */ this__, /* System_Object* */ obj) \
    (il2c_get_vtable(UEFI_Code_ExpressionNode, this__)->Equals((System_Object*)this__, obj))
#define UEFI_Code_ExpressionNode_Reduce(/* UEFI_Code_ExpressionNode* */ this__) \
    (il2c_get_vtable(UEFI_Code_ExpressionNode, this__)->Reduce((UEFI_Code_ExpressionNode*)this__))
...
#define UEFI_Code_PolishNotation_GetHashCode(/* UEFI_Code_PolishNotation* */ this__) \
    (il2c_get_vtable(UEFI_Code_PolishNotation, this__)->GetHashCode((System_Object*)this__))
#define UEFI_Code_PolishNotation_Finalize(/* UEFI_Code_PolishNotation* */ this__) \
    (il2c_get_vtable(UEFI_Code_PolishNotation, this__)->Finalize((System_Object*)this__))
#define UEFI_Code_PolishNotation_Equals(/* UEFI_Code_PolishNotation* */ this__, /* System_Object* */ obj) \
    (il2c_get_vtable(UEFI_Code_PolishNotation, this__)->Equals((System_Object*)this__, obj))
