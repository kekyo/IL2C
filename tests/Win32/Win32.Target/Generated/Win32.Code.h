...
extern const __RUNTIME_TYPE__ __Win32_Code_InheritTypeTest_RUNTIME_TYPE__;
...
extern void Win32_Code_InheritTestTargetBase1__ctor(Win32_Code_InheritTestTargetBase1* __this);
extern void Win32_Code_InheritTestTargetBase1__ctor_1(Win32_Code_InheritTestTargetBase1* __this, int32_t value);
...
typedef const struct __Win32_Code_InheritTestTargetBase1_TYPE_DEF_TYPE__
{
    ...
    void (*Finalize)(System_Object* __this);
    bool (*Equals)(System_Object* __this, System_Object* obj);
    int32_t (*Calc_1)(Win32_Code_InheritTestTargetBase1* __this, int32_t a, int32_t b);
